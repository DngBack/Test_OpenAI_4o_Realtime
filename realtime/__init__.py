...
class RealtimeConversation:
    ...
    def _process_input_audio_transcription_completed(self, event):
        print("_process_input_audio_transcription_completed")
        print(event)
        item_id = event['item_id']
    ...
    def _process_response_created(self, event):
        print("_process_response_created: ")
        print(event)
    ...
    def _process_function_call_arguments_delta(self, event):
        print("_process_function_call_arguments_delta")
        print(event)
        item_id = event['item_id']
        delta = event['delta']
        item = self.item_lookup.get(item_id)
